...
{
    public partial class View_PLANWAVEV
    {
        ...
        [Column(Order = 17)]
        [StringLength(200)]
        public string PlanGoodsIssue_UDF_1 { get; set; }

  
        [Column(Order = 18)]
        [StringLength(200)]
        public string PlanGoodsIssue_UDF_2 { get; set; }

  
        [Column(Order = 19)]
        [StringLength(200)]
        public string PlanGoodsIssue_UDF_3 { get; set; }

  
        [Column(Order = 20)]
        [StringLength(200)]
        public string PlanGoodsIssue_UDF_4 { get; set; }

  
        [Column(Order = 21)]
        [StringLength(200)]
        public string PlanGoodsIssue_UDF_5 { get; set; }
