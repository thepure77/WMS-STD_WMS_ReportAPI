...
{
    public class Report20Service
    {

        #region report20
        public string printReport20(Report20ViewModel data, string rootPath = "")
        {
            ...
            try
            {
                ...
                var result = new List<Report20ViewModel>();
                ...
                if (query.Count == 0)
                {
                    var resultItem = new Report20ViewModel();
                ...
                var reportPath = rootPath + new AppSettingConfig().GetUrl("Report20");
        ...
        public string ExportExcel(Report20ViewModel data, string rootPath = "")
        {
            var BB_DBContext = new BinbalanceDbContext();
