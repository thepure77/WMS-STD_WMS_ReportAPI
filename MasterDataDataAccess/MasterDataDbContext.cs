...
namespace DataAccess
{
    public class MasterDataDbContext : DbContext
    {
        ...
        public virtual DbSet<View_ReportRecall> View_ReportRecall { get; set; }
        ...
        public DbSet<MS_BusinessUnit> MS_BusinessUnit { get; set; }
        ...
        public virtual DbSet<sp_LogLabor> sp_LogLabor { get; set; }

        public virtual DbSet<sp_ReportGI_SN> sp_ReportGI_SN { get; set; }

        public virtual DbSet<sp_GetUniversalSearch> sp_GetUniversalSearch { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                var connectionString = configuration.GetConnectionString("MasterDefaultConnection").ToString();
